...
public class SpaceLaunchPad {
    ...
    public boolean canPlaceOn(Tile tile, Team team, int rotation){
        return spaceStations.contains(p -> p.parent == state.getSector().planet);
    }
    ...
    public class SpaceLaunchPadBuild extends Building {
        ...
        public void updateTile(){
            if(!state.isCampaign() || spaceStations.contains(p -> p.parent == state.getSector().planet)) return;
    ...
    static abstract class SpaceLaunchPayloadComp implements Drawc, Timedc, Teamc{
        ...
        public void draw(){
            ...
            TextureRegion region = blockOn() instanceof SpaceLaunchPad p ? p.podRegion : Core.atlas.find("disintegration-launchpod-large");
            scale *= region.scl();
        ...
        public void remove(){
            ...
            Planet planet = spaceStations.find(p -> p.parent == state.getSector().planet);
            Sector sector = planet.getSector(PlanetGrid.Ptile.empty);
